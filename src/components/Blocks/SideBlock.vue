    ...
    <div class="tab-content" id="pills-tabContent">
      <div class="tab-pane fade show" :class="(tab == 1) ? 'active' : ''" id="pills-vovl" role="tabpanel" aria-labelledby="pills-home-vovl">
        <div class="row graphs">
          <div class="col-md-auto rgraph">
            <VovlChart :value="group.sideBar['Вовлечение'].charts.vovl.value" :delta="group.sideBar['Вовлечение'].charts.vovl.delta" class="animate__animated animate__fadeInUp" />
          </div>
          <div class="col-md-auto rgraph">
            <BurnoutChart :value="group.sideBar['Вовлечение'].charts.burnout.value" :delta="group.sideBar['Вовлечение'].charts.burnout.delta" class="animate__animated animate__fadeInUp" />
          </div>
        </div>
      </div>
      <div class="tab-pane fade show" :class="(tab == 2) ? 'active' : ''" id="pills-mot" role="tabpanel" aria-labelledby="pills-home-mot">
        <div class="row graphs">
          <div class="col-md-auto rgraph">
            <MotivationRadial :value="group.sideBar['Мотивация'].charts.motivation.value" :delta="group.sideBar['Мотивация'].charts.motivation.delta" class="animate__animated animate__fadeInUp" />
          </div>
          <div class="col-md-auto rgraph">
            <ActivityRadial :value="group.sideBar['Мотивация'].charts.activity.value" :delta="group.sideBar['Мотивация'].charts.activity.delta" class="animate__animated animate__fadeInUp" />
          </div>
        </div>
      </div>
    </div>
...
<script>
import VovlChart from "@/components/Charts/VovlChart";
import BurnoutChart from "@/components/Charts/BurnoutChart";
import MotivationRadial from "@/components/Charts/MotivationRadial";
import ActivityRadial from "@/components/Charts/ActivityRadial";

export default {
  name: "SideBlock",
  components: {
    VovlChart, BurnoutChart, MotivationRadial, ActivityRadial
  },
  props: {
    group: Object
  },
